  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing rounded-[30px]"
      />
...
left-60
    ...
    translate-x-[20%]
    -translate-y-1/2
    text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[2rem]
    font-extrabold
    tracking-wide

    bg-gradient-to-r from-[#ab1428] via-[#c61a32] to-[#ab1428]
    bg-clip-text text-transparent

    drop-shadow-[0_0_10px_rgba(171,20,40,0.45)]

    transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
    ${
      isMoving
        ? 'opacity-0 pointer-events-none duration-[120ms] scale-95'
        : 'opacity-100 pointer-events-auto duration-[550ms] scale-100'
    }
  `}
>
  {activeItem.title}
...
<p
  className={`
    ...
    bg-gradient-to-br from-white via-[#e6e6e6] to-[#cccccc]
    ...
    ${
      isMoving
        ? 'opacity-0 pointer-events-none duration-[120ms] translate-x-[-40%] -translate-y-1/2 blur-[2px]'
        : 'opacity-100 pointer-events-auto duration-[550ms] translate-x-[-60%] -translate-y-1/2 blur-0'
    }
  `}
>
...
<p
  className={`
    ...
    border
    left-[86%]
    text-sm sm:text-base md:text-lg lg:text-xl xl:text-[1.35rem]
    font-medium
    leading-relaxed
