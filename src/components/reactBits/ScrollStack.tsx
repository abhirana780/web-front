...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const triggerStart = triggerScrollY !== undefined ? triggerScrollY + itemStackDistance * i : cardTop - stackPositionPx - itemStackDistance * i;
      ...
      if (i === cardsRef.current.length - 1) {
        ...
        if (isInView && !stackCompletedRef.current) {
          ...
          onStackComplete?.();
        } else if ((!isInView || scrollTop <= 0) && stackCompletedRef.current) {
          // Reset stackCompletedRef when scrolling above start or back to top
